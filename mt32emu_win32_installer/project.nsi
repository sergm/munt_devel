...
Section "Uninstall"
  ...
  Delete "$INSTDIR\include\mt32emu\Poly.h"
  Delete "$INSTDIR\include\mt32emu\ROMInfo.h"
  Delete "$INSTDIR\include\mt32emu\Structures.h"
  Delete "$INSTDIR\include\mt32emu\Synth.h"
  Delete "$INSTDIR\include\mt32emu\Tables.h"
  Delete "$INSTDIR\include\mt32emu\TVA.h"
  Delete "$INSTDIR\include\mt32emu\TVF.h"
