...
Section "Uninstall"
  ...
  Delete "$INSTDIR\mt32emu_win32drv\infinstall.exe"
  Delete "$INSTDIR\mt32emu_win32drv\infinstall_x64.exe"
  Delete "$INSTDIR\mt32emu_win32drv\mt32emu.cat"
  ...
  Delete "$INSTDIR\docs\mt32emu\README.html"
  Delete "$INSTDIR\docs\mt32emu\README.md"
  ...
  Delete "$INSTDIR\docs\mt32emu_qt\README.html"
  Delete "$INSTDIR\docs\mt32emu_qt\README.md"
  ...
  Delete "$INSTDIR\docs\mt32emu_smf2wav\README.html"
  Delete "$INSTDIR\docs\mt32emu_smf2wav\README.md"
  ...
  Delete "$INSTDIR\docs\mt32emu_win32drv\README.html"
  Delete "$INSTDIR\docs\mt32emu_win32drv\README.md"
